<template>
  <div>
    ...
    <div class="dark:prose-dark prose md:prose-xl mt-8 md:mt-0">
      ...
      <p>I created a calendar displaying all of my monthly activities logged to Strava.</p>
...
export default {
  ...
  async asyncData({ $axios }) {
    ...
    const activityEndpoint = "https://maotterson.com/.netlify/functions/strava-test"
